			...
			public void actionPerformed(ActionEvent e) {
        		...
        		submitButton.addActionListener(new ActionListener() {
        			public void actionPerformed(ActionEvent e) {
        				...
        				/*
        				mealData.setDate(date); //storing data in usermealdata class
        				*/
        				System.out.println("food type: " + foodString); //printing the food type (for test only)
        				/*
        				mealData.setMealType(foodString); //storing data in usermealdata class
        				*/
                        ...
                        nextButton.addActionListener(new ActionListener() {
                            public void actionPerformed(ActionEvent e) {
                                if (yesButton.isSelected()) {
                    				...
                    				/*
                    				mealData.addToIngredientsList(ingredientString); //storing data in usermealdata class
                    				mealData.addToQuantityList(quantityString); //storing data in usermealdata class
                    				*/
